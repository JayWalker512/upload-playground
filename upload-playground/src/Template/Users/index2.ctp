<nav class="large-3 medium-4 columns" id="actions-sidebar">
    ...
    echo $this->Form->control('role', ['options' => $roles, 'empty' => 'Any']);
...
<div class="users index large-9 medium-8 columns content">
    ...
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                <?php $this->Paginator->options(['defaultModel' => 'u']) ?>
    ...
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                <?php $this->Paginator->options(['defaultModel' => 'o']) ?>
                <th scope="col"><?= $this->Paginator->sort('id') ?></th>
                <th scope="col"><?= $this->Paginator->sort('photo_path') ?></th>
                <th scope="col"><?= $this->Paginator->sort('time_added') ?></th>
            </tr>
        </thead>
        <tbody>
